...
export default function CategoriesSideNav() {
  ...
  return (
    <ul className="flex sm:flex-col pt-4 gap-1 sm:ltr:border-r-1 sm:rtl:sm:border-l-1 sm:border-black/40 w-[300px] h-fit max-sm:overflow-x-scroll hide-scrollbar max-sm:w-full max-sm:gap-[1px]">
