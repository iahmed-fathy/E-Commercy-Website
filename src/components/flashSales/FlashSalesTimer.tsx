  ...
  return (
    <div className="grid grid-cols-8 gap-2 items-center text-center justify-between w-[350px] mx-auto">
      <div className="flex flex-col items-center">
        <span className="font-medium test-[12px]">Days</span>
      ...
      <div className="flex flex-col items-center">
        <span className="font-medium test-[12px]">Hours </span>
        <span className="font-bold text-[32px]">
      ...
      <div className="flex flex-col items-center">
        <span className="font-medium test-[12px]">Minutes </span>
        <span className="font-bold text-[32px]">
      ...
      <div className="flex flex-col items-center">
        <span className="font-medium test-[12px]">Seconds </span>
        <span className="font-bold text-[32px]">
